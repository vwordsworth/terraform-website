...
`data.attributes.speculative-enabled`         | boolean | true      | Whether pull request based runs should be executed on this workspace.
...
`data.attributes.speculative-enabled`         | boolean        | (previous value) | Whether pull request based runs should be executed on this workspace.
